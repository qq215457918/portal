...
<script src="resources/js/customer/customer_info_index.js" type="text/javascript"></script>
...
<body>
	...
	<div class="modal-shiftfix">
		<div class="container-fluid main-content">
			...
			<div class="col-lg-12 ml10">
				<div class="widget-container fluid-height clearfix">
					<div class="widget-content padded">
						<div class="form-group">
							<label class="control-label col-md-2 swidth">电话号码</label>
							<div class="col-md-2">
								<input class="form-control" placeholder="电话号码" type="text" id="phone">
							</div>
							
							<label class="control-label col-md-2 swidth">号码段</label>
							<div class="col-md-2">
								<input class="form-control" placeholder="号码段" type="text" id="phoneStage">
							</div>
