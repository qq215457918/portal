							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input class="form-control" data-date-autoclose="true"
										data-date-format="yyyy-mm-dd" id="importDate1"
										placeholder="开始时间" type="text">
								</div>
								<div class="col-sm-2">
									<input class="form-control" data-date-autoclose="true"
										data-date-format="yyyy-mm-dd" id="importDate2"
						...
						<div class="form-group" style="margin-top: 10px;">
							<div class="col-md-7">
								...
								<button class="btn btn-primary" data-toggle="modal"
									data-target="#importExcel">导入</button>
								<%-- 只有在管理人员导入空白客户信息时才打开此按钮 --%>
								<button class="btn btn-primary" data-toggle="modal"
									data-target="#importEmptyExcel">导入空白客户</button>
							</div>
						</div>
						<!-- DataTables Example -->
	...
	<div class="modal fade" id="importEmptyExcel">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="customerInfo/importEmptyCustomer" method="post"
						id="importEmptyExcelForm" enctype="multipart/form-data">
						<h4>客户所属区域</h4>
						<p>
							...
							<div class="input-group">
								...
								<div class="input-group-btn">
									<span class="btn btn-default btn-file"> <span
										class="fileupload-new">选择文件</span> <input type="file"
										id="eptyCustomerFile" name="eptyCustomerFile"
										multiple="multiple">
									</span>
								</div>
							</div>
				...
				<div class="modal-footer">
					<button class="btn btn-primary" type="button"
						onclick="javascript: $('#importEmptyExcelForm').submit()">导入</button>
					<button class="btn btn-default-outline" data-dismiss="modal"
						type="button">关闭</button>
				</div>
			</div>
