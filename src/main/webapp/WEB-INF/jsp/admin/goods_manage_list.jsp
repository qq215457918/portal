...
<script type="text/javascript"
	src="resources/js/admin/goods_manage_list.js"></script>
					...
					<div class="widget-content padded">
						<div class="form-group condition-group">
							<div class="condition fl">
								...
								<div class="condition-control fl">
									<div class="col-md-7" style="width: 100%;">
										<input class="form-control" placeholder="藏品名称" id="name"
							...
							<div class="condition fl">
								...
								<div class="condition-control fl">
									<div class="col-md-7" style="width: 100%;">
										<select id="bigSortId" class="form-control"
											style="width: 100%;">
							...
							<div class="condition fl">
								...
								<div class="condition-control fl">
									<div class="col-md-7" style="width: 100%;">
										<input class="form-control" placeholder="藏品序号" id="code"
											type="text" style="width: 100%;">
									</div>
								</div>
							</div>
							...
							<div class="condition fl">
								...
								<div class="condition-control fl">
									<div class="col-md-7" style="width: 100%;">
										<select id="repurchaseFlag" class="form-control"
											style="width: 100%;">
											<option value="">请选择</option>
