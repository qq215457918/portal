...
<jsp:include page="/WEB-INF/jsp/common/include.jsp" />
	...
	<script type="text/javascript" src="resources/js/myjob/exchange_check.js"></script>
  </head>
  <body>
            ...
            <div class="widget-content padded">
              <form action="#" class="form-horizontal">
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <label class="control-label col-md-4">兑换信息</label>
                    <div class="col-md-8">
                      <input class="form-control" placeholder="请输入兑换名称" type="text" id="goodName">
                    </div>
                  </div>
                  <div class="col-md-6">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
      	 ...
      	 客户姓名： <input class="form-control" value="" type="text" id="customerName" readonly ="readonly">	  
                          兑换名称： <input class="form-control" value="" type="text" id="applyGoodsName" readonly ="readonly">
