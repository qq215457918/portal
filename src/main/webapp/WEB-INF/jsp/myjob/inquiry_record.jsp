...
<script type="text/javascript"
	src="resources/js/reception/inquiry_record.js"></script>
				...
				<div class="widget-container fluid-height clearfix">
					<div class="heading" style="color: #666666; font-weight: bold;">
						<i class="icon-reorder"
							style="float: left; margin-top: 0.8%; cursor: default;">接待业务查询表</i>
					</div>
						...
						<div class="form-group" style="margin-left: 9.2%; height: 35px;">
								...
								<div style="width: 65%; float: left;">
									<div class="col-md-3" style="width: 100%;">
										<div class="input-group date datepicker">
											<input class="form-control" type="text" id="startReportDate"
												value="${startReportDate }" readonly="readonly"><span
							...
							<div style="height: 50px; float: left; width: 40%;">
								...
								<div style="width: 65%; float: left;">
									<div class="col-md-3" style="width: 100%;">
										<div class="input-group date datepicker">
											<input class="form-control" type="text" id="endReportDate"
												value="${endReportDate }" readonly="readonly"><span
												class="input-group-addon"><i class="icon-calendar"></i></span>
										</div>
									</div>
								</div>
							...
							<div style="height: 50px; float: left; width: 40%;">
								...
								<div style="width: 65%; float: left;">
									<div class="col-md-7" style="width: 100%;">
										<input class="form-control" placeholder="接待员姓名"
											id="receiverStaffName" type="text" style="width: 100%;">
									</div>
								</div>
							</div>
							<div
								style="height: 50px; float: left; width: 20%; margin-left: 20px;">
