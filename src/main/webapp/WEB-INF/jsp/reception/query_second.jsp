		...
		<div class="row">
			<div class="col-lg-6">
				<div class="widget-container fluid-height clearfix">
					<div class="heading">
						<a name="tab"
							href="${base}order/manage/init?active=5&cId=<%=session.getAttribute("cId")%>"><i
					...
					<div class="widget-content padded clearfix">
	                    ...
	                    ${detail.price } <i class="icon-yen"></i>
										...
										<td>${status.createDateString }</td>
										<td>${status.payPrice }</td>
										<td>${status.receiverStaffName }</td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
			...
			<div class="col-lg-6">
				<div class="widget-container fluid-height clearfix">
					<div class="heading">
						<a name="tab"
							href="${base}reception/init?active=7&cId=<%=session.getAttribute("cId")%>"><i
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="widget-container fluid-height clearfix">
					<div class="heading">
						<a name="tab"
							href="${base}repurchase/init?active=4&cId=<%=session.getAttribute("cId")%>"><i
			...
			<div class="col-lg-6">
				<div class="widget-container fluid-height clearfix">
					<div class="heading">
						<a name="tab"
							href="${base}order/manage/init?active=5&cId=<%=session.getAttribute("cId")%>">
...
<script>
	$(function() {
		...
		$("#modifyExchange").click(
				function() {
					var id = $('#cid').val();
					window.location.href = base
							+ "/customer/modify/exchange?cId=" + id;
				});
	});
</script>
</html>