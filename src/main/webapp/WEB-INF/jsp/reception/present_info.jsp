...
<body>
				...
				<div class="widget-container fluid-height clearfix">
					...
					<div class="widget-content text-center">
						...
						<div class="form-group">
										...
										<c:forEach var="list" items="${goodsInfoList}" varStatus="var">
											<tr>
												...
												<td><label class='checkbox-inline'
													style='padding-top: 0px; margin-right: 0px'> <input
														type='checkbox' name='row_checkbox' id="${list.id}"
														value="${list.name}"><span></span>
												</label></td>
											</tr>
										</c:forEach>
									</tbody>
							...
							<input class="btn btn-info" type="submit" id="presentReceive"
								value="确定领取">
						</div>
					</div>
				</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">请输入审批原因</h4>
				</div>
				<div class="modal-body">
					...
					</select> 赠品数量： <input class="form-control" value="1" type="text"
						id="applyCount"> 申请原因：
					<textarea class="form-control" rows="3" id="applyReason"></textarea>
				</div>
				<div class="modal-footer">
					<button class="btn btn-primary" type="button" id="appConfirm">确
						认</button>
	...
	<script>
		$(function() {
			...
			$("#appConfirm").click(
					function() {
						var goodId = $('#applyGoods').find("option:selected")
								.val();
						var goodName = $('#applyGoods').find("option:selected")
								.text();
			...
			$("#presentReceive")
					.click(
							function() {
								...
								var goodName = "";
								//获取所选赠品
								if ($(":checkbox[name=row_checkbox]:checked")
										.size() > 0) {
									$("input[name=row_checkbox]:checked").each(
											function() {
												goodId += $(this).attr("id")
														+ ",";
												goodName += $(this).attr(
