...
<script src="resources/js/reception/order_modify.js" type="text/javascript"></script>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="order/orderModifyInfo" method="post" id="orderModifyForm">
						<div class="row">
							<div class="form-group">
								<label class="control-label col-md-2 swidth">客户电话</label>
								<div class="col-sm-5">
					...
					<div class="modal-footer">
						<button class="btn btn-primary" type="button" onclick="javascript: $('#orderModifyForm').submit();$('#searchList').click();">修改</button>
