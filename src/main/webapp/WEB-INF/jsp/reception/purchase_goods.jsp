...
<title>购买商品</title>
<base href="${basePath}">
<script src="resources/js/reception/purchase_goods.js"
					...
					<div class="col-xs-12">
						<div class="widget-container">
							...
							<div class="widget-content padded">
								...
								<div class="row">
									<div
										style="float: right; margin-right: 40px; font-size: 1.2em; color: red;">
					...
					<div class="col-xs-12">
						<div class="widget-container fluid-height clearfix">
								...
								<form action="#" class="form-horizontal">
									<div class="form-group">
										<div class="col-xs-6">
											...
											<div class="col-xs-6">
												<input class="form-control" placeholder="商品名称或者编码"
							...
							<div class="widget-container fluid-height clearfix">
								...
								<!--add myModal start-->
								<div class="widget-content padded">
									<a class="btn btn-primary btn" onclick='openDelivery();'>配
										送</a> <a class="btn btn-warning btn" onclick='openPlacing();'>配
										售</a> <a class="btn btn-default btn" onclick='openGifts();'>VIP赠
										品</a>
								</div>
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button class="btn btn-primary" type="button"
													onclick='addOtherGoods();'>添加到购物车</button>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												...
												<h4 class="modal-title">订单提交提示</h4>
											</div>
											<div class="modal-body">
