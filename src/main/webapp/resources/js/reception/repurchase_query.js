			...
			.dataTable(
					{
						...
						"aoColumns" : [
								...
								},
								{
									...
									"render" : function(data, type, full) {
										var result = "";
										var normalButton = "<button class='btn btn-block btn-warning' id='cId"
												+ data
												+ "' onclick='normal(&quot;"
												+ data
												+ "&quot;,&quot;"
												...
												+ "&quot;,&quot;"
												+ full.price
												+ "&quot;);'>正常回购</button>";// customerId
										var specialButton = "<button class='btn btn-block btn-dnager' id='cId"
												+ data
												+ "' onclick='special(&quot;"
												+ data
												+ "&quot;,&quot;"
