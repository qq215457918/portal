			...
			.dataTable(
					{
						...
						"aoColumns" : [
								...
								},
								{
									"data" : "orderNumber",
									"render" : function(data, type, full) {
										var specialButton = "<button class='btn btn-info btn-block' onclick='approved(&quot;"
												+ full.orderNumber
												+ "&quot;,&quot;"
												+ full.customerName
												+ "&quot;,&quot;"
