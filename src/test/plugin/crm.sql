...
CREATE TABLE `order_detail_info` (
  ...
  `order_type` varchar(1) COLLATE utf8_bin DEFAULT NULL COMMENT '商品类型 1正常 2退货 3换货 4赠品 5回购 6VIP赠品 7回购待确认',
...
CREATE TABLE `order_info` (
  ...
  `order_type` varchar(1) COLLATE utf8_bin DEFAULT NULL COMMENT '订单类型 1正常 2退货(detail) 3换货(去掉) 4赠品 5回购 6VIP赠品 7回购待确认 8兑换',
